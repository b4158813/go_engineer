...
const (
	...
	Greeter_SayHelloStreamReply_FullMethodName = "/hellogrpc.Greeter/SayHelloStreamReply"
)
...
type GreeterClient interface {
	...
	SayHelloStreamReply(ctx context.Context, in *HelloRequestList, opts ...grpc.CallOption) (Greeter_SayHelloStreamReplyClient, error)
}
...
func (c *greeterClient) SayHelloStreamReply(ctx context.Context, in *HelloRequestList, opts ...grpc.CallOption) (Greeter_SayHelloStreamReplyClient, error) {
...
type GreeterServer interface {
	...
	// 注册SayHelloStreamReply rpc调用
	SayHelloStreamReply(*HelloRequestList, Greeter_SayHelloStreamReplyServer) error
...
func (UnimplementedGreeterServer) SayHelloStreamReply(*HelloRequestList, Greeter_SayHelloStreamReplyServer) error {
